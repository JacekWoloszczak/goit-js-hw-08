...
u=setTimeout(h,t),S(f))}return void 0===u&&(u=setTimeout(h,t)),l}return t=b(t)||0,y(n)&&(s=!!n.leading,a=(d="maxWait"in n)?g(b(n.maxWait)||0,t):a,m="trailing"in n?!!n.trailing:m),O.cancel=function(){void 0!==u&&clearTimeout(u),c=0,o=f=r=u=void 0},O.flush=function(){return void 0===u?l:T(p())},O}(e,t,{leading:o,maxWait:t,trailing:r})};let S=document.querySelector(".feedback-form"),j=S.querySelector('input[name="email"]'),h=S.querySelector('textarea[name="message"]'),T="feedback-form-state";((e=n)&&e.__esModule?e.default:e)(()=>{}),S.elements.email.value=localStorage.getItem(T)??"",S.elements.message.value=localStorage.getItem(T)??"",S.addEventListener("input",e=>{localStorage.setItem(T,e.target.value)}),S.addEventListener("submit",()=>{let e={email:j.value,message:h.value};localStorage.setItem(T,JSON.stringify(e)),console.log(e),localStorage.removeItem(T),S.reset()})}();//# sourceMappingURL=03-feedback.14fc40a3.js.map

//# sourceMappingURL=03-feedback.14fc40a3.js.map
