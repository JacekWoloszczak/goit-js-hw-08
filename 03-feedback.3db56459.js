...
return void 0===l||n>=t||n<0||d&&i>=a}function h(){var e,n,i,o=g();if(S(o))return O(o);// Restart the timer.
f=setTimeout(h,(e=o-l,n=o-c,i=t-e,d?p(i,a-n):i))}function O(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(f=void 0,m&&o)?j(e):(o=r=void 0,u))}function T(){var e,n=g(),i=S(n);if(o=arguments,r=this,l=n,i){if(void 0===f)return(// Reset any `maxWait` timer.
c=e=l,// Start the timer for the trailing edge.
f=setTimeout(h,t),s?j(e):u);if(d)return(// Handle invocations in a tight loop.
f=setTimeout(h,t),j(l))}return void 0===f&&(f=setTimeout(h,t)),u}return t=b(t)||0,y(n)&&(s=!!n.leading,a=(d="maxWait"in n)?v(b(n.maxWait)||0,t):a,m="trailing"in n?!!n.trailing:m),T.cancel=function(){void 0!==f&&clearTimeout(f),c=0,o=l=r=f=void 0},T.flush=function(){return void 0===f?u:O(g())},T}(e,t,{leading:o,maxWait:t,trailing:r})};const j=document.querySelector(".feedback-form"),S=j.querySelector('input[name="email"]'),h=j.querySelector('textarea[name="message"]'),O="feedback-form-state",T=JSON.parse(localStorage.getItem(O));T&&(S.value=T.email,h.value=T.message);const w=((e=n)&&e.__esModule?e.default:e)(()=>{let e={email:S.value,message:h.value};localStorage.setItem(O,JSON.stringify(e))},500);j.addEventListener("input",w),j.addEventListener("submit",e=>{e.preventDefault();let t={email:S.value,message:h.value};console.log(t),localStorage.removeItem(O),j.reset()});//# sourceMappingURL=03-feedback.3db56459.js.map

//# sourceMappingURL=03-feedback.3db56459.js.map
