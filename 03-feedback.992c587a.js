...
f=setTimeout(h,t),j(l))}return void 0===f&&(f=setTimeout(h,t)),u}return t=b(t)||0,y(n)&&(s=!!n.leading,a=(d="maxWait"in n)?v(b(n.maxWait)||0,t):a,m="trailing"in n?!!n.trailing:m),T.cancel=function(){void 0!==f&&clearTimeout(f),c=0,o=l=r=f=void 0},T.flush=function(){return void 0===f?u:O(g())},T}(e,t,{leading:o,maxWait:t,trailing:r})};let j=document.querySelector(".feedback-form"),S=j.querySelector('input[name="email"]'),h=j.querySelector('textarea[name="message"]'),O="feedback-form-state",T=JSON.parse(localStorage.getItem(O));T&&(S.value=T.email,h.value=T.message);let w=((e=n)&&e.__esModule?e.default:e)(()=>{let e={email:S.value,message:h.value};localStorage.setItem(O,JSON.stringify(e))},500);j.addEventListener("input",w),j.addEventListener("submit",e=>{e.preventDefault();let t={email:S.value,message:h.value};console.log(t),localStorage.removeItem(O),j.reset()})}();//# sourceMappingURL=03-feedback.992c587a.js.map

//# sourceMappingURL=03-feedback.992c587a.js.map
