...
u=setTimeout(h,t),j(f))}return void 0===u&&(u=setTimeout(h,t)),l}return t=b(t)||0,y(n)&&(c=!!n.leading,a=(m="maxWait"in n)?v(b(n.maxWait)||0,t):a,d="trailing"in n?!!n.trailing:d),O.cancel=function(){void 0!==u&&clearTimeout(u),s=0,o=f=r=u=void 0},O.flush=function(){return void 0===u?l:T(p())},O}(e,t,{leading:o,maxWait:t,trailing:r})};let j=document.querySelector(".feedback-form");j.querySelector('input[name="email"]'),j.querySelector('textarea[name="message"]');let S="feedback-form-state",h=((e=n)&&e.__esModule?e.default:e)(e=>{e.preventDefault()},500);j.elements.email.value=localStorage.getItem(S)??"",j.elements.message.value=localStorage.getItem(S)??"",j.addEventListener("input",h),j.addEventListener("input",e=>{let t={email:j.elements.email.value,message:j.elements.message.value};localStorage.setItem(S,JSON.stringify(t));// localStorage.setItem(STORAGE, event.target.value);
...
console.log(t),localStorage.removeItem(S),j.reset()})}();//# sourceMappingURL=03-feedback.63da939d.js.map

//# sourceMappingURL=03-feedback.63da939d.js.map
